...
|
*/
//Route::get('/webhookForPayu/{order_id}/{status}', 'HomeController@webhookForPayu');
/*below ccavenue path is for testing with static response of webhook*/
//Route::get('/webhookForCCAvenue', 'HomeController@webhookForCCAvenue');
Route::get('/webhookForPayu', 'HomeController@webhookForPayu');
/*Uncomment below route when check for live webhook response */
Route::post('/webhookForCCAvenue', 'HomeController@webhookForCCAvenue');
