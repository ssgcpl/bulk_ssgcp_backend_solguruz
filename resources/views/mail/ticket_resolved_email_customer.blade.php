@component('mail::message')
	...
	This is just a quick note to inform you that your ticket has been resolved [Ticket ID: {{$ticket->id}} dated {{date('d-m-Y',strtotime($ticket->created_at))}}].
	<br/><br/>
	Admin Comments: {{$ticket->comment}}
 	<br/>
 	<br/> 
