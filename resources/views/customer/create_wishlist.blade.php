  ...
  <section class="inner-page-banner">
      <div class="container"> 
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">@if(app('request')->input('qty')) <a href="{{route('create_wishlist',$book_id)}}?qty={{app('request')->input('qty') ?? 0}}">Create Wishlist</a> @else <a href="{{route('create_wishlist',$book_id)}}">Create Wishlist</a> @endif</li>
        </ol> 
      </div>
  </section> 
