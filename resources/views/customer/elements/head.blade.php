...
<meta name="theme-color" content="#33A1E1" />
<!-- Favicon -->
<link rel="icon" href="{{asset('web_assets/images/favicon.png')}}" type="image/png">
...
<link rel="stylesheet" href="{{asset('web_assets/css/intlTelInput.min.css')}}" />
...
<!-- Custom CSS -->
<link rel="stylesheet" href="{{asset('web_assets/css/iconmoon.css')}}">
