  ...
  <section class="inner-page-banner">
      <div class="container"> 
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active"><a href="{{ Route::currentRouteName() }}">My Order </a> </li>
        </ol> 
      </div>
  </section> 
  ...
  <section class="my-order white-bg">
    <div class="container">
      <div class="section-title">
        <h2>My Order</h2>
        <a href="#" title="" data-bs-toggle="modal" data-bs-target="#filter-modal"><img src="{{asset('web_assets/images/filter.svg')}}" alt="" /></a>        
      </div> 
