...
<div class="main-wapper">
  ...
  <section class="inner-page-banner">
      <div class="container"> 
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active"> <a href="{{ route('request_wishlist_detail',$wishreturn_request_id) }}">Wish Order Detail</a>  </li>
        </ol> 
      </div>
  </section> 
  ...
  <section class="my-cart">     
    <div class="container">
      ...
      <input type="hidden" name="hdn_wishreturn_request_id" ID="hdn_wishreturn_request_id"  value="{{$wishreturn_request_id}}">
      <div class="row">
          ...
          <div class="order-list">
            ...
            <div class="details"> 
              <div class="row">
                ...
                <div class="col-4">
                  <div class="list mb-2">
                    <div class="secondary-color">Order Time</div>
                    <p id="time"></p>                
                  </div>
                </div>
                <div class="col-4">
