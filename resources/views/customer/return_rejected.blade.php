  ...
  <section class="inner-page-banner">
      <div class="container"> 
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active"> <a href="{{ route('return_rejected',$id) }}">Return Rejected</a> </li>
        </ol> 
      </div>
  </section> 
    ...
    <div class="container">
      <div class="row align-items-center justify-content-center">
        <div class="col-xl-7 col-lg-7 col-md-12">
          <div class="section-title justify-content-center"><h2>Return Rejected</h2></div>
          ...
          <div class="order-list white-bg">
            <div class="head">
              ...
              <div><span class="theme-red-color" id="status"></span></div>
            </div>
            <div class="details"> 
              <ul>
