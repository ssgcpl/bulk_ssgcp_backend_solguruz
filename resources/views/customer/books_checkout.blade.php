        ...
        <div class="col-xl-8 col-lg-8 col-md-12 col-12">
          ...
          <div class="default-address"> 
            ...
            <div class="same-billing white-bg" id="payment_method">
              <h6>Payment</h6>
                <input type="radio" name="payment_method" id="ccavenue" value="ccavenue"> <label class="checkmark" for="ccavenue">CC Avenue</label>
                <br>
                <input type="radio" name="payment_method" id="payu" value="payu"> <label class="checkmark" for="payu">Payu</label>
