                ...
                <div class="col-12">
                    ...
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">{{ trans('countries.plural') }}
                            </li>
                        </ol>
                    </div>
                </div>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title">{{ trans('countries.title') }}</h4>
                @can('country-create')
                  <!-- <div class="box-tools pull-right">
                    <a href="{{ route('country.create') }}" class="btn btn-success pull-right">
      ...
      processing: true,
       lengthMenu: [[10, 25, 50, 100, -1], [10, 25, 50, 100,"All"]],
        ...
        language: {
              ...
              emptyTable: "{{trans('datatable.empty_countries')}}",
              zeroRecords:"{{trans('datatable.no_countries')}}",
            },
      ajax: {
