              ...
              <div class="col-12">
                  ...
                  <div class="breadcrumb-wrapper col-12">
                      <ol class="breadcrumb">
                          ...
                          <li class="breadcrumb-item"><a
                                  href="{{ route('order_return.edit',$_GET['order_return_id']) }}">{{ trans('order_return.update') }}</a></li>
                          <li class="breadcrumb-item active">{{ trans('order_return.view_product') }}
                          </li>
                      </ol>
                  </div>
              </div>
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
                <h4 class="card-title">
                    {{ trans('order_return.product_detail') }}
                </h4>
                @can('product-list')
                    <a href="{{ route('order_return.edit',$_GET['order_return_id']) }}" class="btn btn-success">
