  ...
  <div class="app-content content">
    ...
    <div class="content-wrapper">
        ...
        <div class="content-body">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <div class="avatar bg-rgba-warning p-50 m-0 mb-1">
                                    <div class="avatar-content">
                                        <a href="{{route('orders.index')}}" title="order_placed"> <i class="feather text-primary icon-shopping-cart font-medium-5"></i></a>
                                    </div>
                                </div>
                    ...
                    <div class="card text-center">
                        <div class="card-content">
                            <div class="card-body">
                                <div class="avatar bg-rgba-info p-50 m-0 mb-1">
                                    <div class="avatar-content">
                                       <a href="{{route('wish_return.index')}}" title="tickets">
            ...
            <div class="row">
                <div class="col-md-8">  <h2 class="content-header-title float-left mb-0">{{trans('dashboard.today_statistics')}} </h2></div>
                         <div class="col-md-4">
