                    ...
                    <div class="row">
                      <div class="col-md-6">
                              <div class="form-group ">
                                ...
                                <input class="form-control @error('pof_no') ? is-invalid : ''  @enderror" placeholder="{{trans('stocks.pof_no')}}" name="pof_no" type="text" value="{{$stock->pof_no}}" required>
                      ...
                      <div class="col-md-6">
                              <div class="form-group ">
                                ...
                                <input class="form-control @error('pof_qty') ? is-invalid : ''  @enderror" placeholder="{{trans('stocks.pof_qty')}}" name="pof_qty" type="text" value="{{$stock->pof_qty}}" required>
                      ...
                      <div class="col-md-6">
                              <div class="form-group ">
                                ...
                                <input class="form-control @error('ecm_no') ? is-invalid : ''  @enderror" placeholder="{{trans('stocks.ecm_no')}}" name="ecm_no" type="text" value="{{$stock->ecm_no}}" required>
                      ...
                      <div class="col-md-6">
                              <div class="form-group ">
                                ...
                                <input class="form-control @error('ecm_qty') ? is-invalid : ''  @enderror" placeholder="{{trans('stocks.ecm_qty')}}" name="ecm_qty" type="text" value="{{$stock->ecm_qty}}" required>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                              <div class="form-group ">
                                ...
                                <input class="form-control @error('gro_no') ? is-invalid : ''  @enderror"  placeholder="{{trans('stocks.gro_no')}}" name="gro_no[]" type="text" value="{{$sg->gro_no}}" required>
                            ...
                            <div class="col-md-6">
                              <div class="form-group ">
                                ...
                                <input class="gro_qty form-control @error('gro_qty') ? is-invalid : ''  @enderror"  placeholder="{{trans('stocks.gro_qty')}}" name="gro_qty[]" type="text" value="{{$sg->gro_qty}}" required>
    ...
    var product_id = $("#product_id").val();
     ...
     $('#createForm').submit(function(evt){
          ...
          var data = new FormData(form);
           ...
           var route = "{{route('stocks.update',':id')}}";
          route = route.replace(':id', '{{$stock->id}}');
