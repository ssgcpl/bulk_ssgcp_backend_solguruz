                                ...
                                <div class="card-header">
                                    ...
                                    @can('stock-create')
                                        <div class="box-tools pull-right">
                                            ...
                                            <a href="{{ route('stocks.create') }}?prod_id={{ $_REQUEST['prod_id'] }}"
                                                class="btn btn-success pull-right">
                                                {{ trans('stocks.add_new') }}
                                            </a>
                                            <a href="{{ route('stocks_transfer.index') }}?prod_id={{ $_REQUEST['prod_id'] }}"
                                                class="btn btn-success pull-right" style="margin-right:10px">
                                                {{ trans('stocks_transfer.transfer_stock') }}
                                            </a>
                                            <a href="{{ route('stock_report.index') }}" style="margin-right:10px"
                                                class="btn btn-success pull-right">
                                        ...
                                        <table class="table zero-configuration">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>{{ trans('stocks.gto_in_qty') }}</th>
                                                    <th>{{ trans('stocks.gto_out_qty') }}</th>
