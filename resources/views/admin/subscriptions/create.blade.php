                ...
                <div class="col-12">
                    ...
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">{{ trans('subscriptions.add_new') }}
                            </li>
                        </ol>
                    </div>
                </div>
        ...
        <div class="col-12">
          <div class="card">
            ...
            <div class="card-content">
              <div class="card-body">    
                <form method="POST" id="SubscriptionForm" action="{{route('subscriptions.store')}}" accept-charset="UTF-8" enctype="multipart/form-data" >
                  @csrf
                  <div class="form-body">
                  <div class="row">
                    <div class="col-md-12">
                     <div class="form-group">
                        ...
                        <input class="form-control" minlength="2" maxlength="190" placeholder="{{trans('subscriptions.pl_name')}}" name="name" value="{{old('name')}}" required type="text">
                        @if ($errors->has('name')) 
                  ...
                  <div class="row">
                    <div class="col-md-12">
                     <div class="form-group">
                        ...
                        <input class="form-control" placeholder="{{trans('subscriptions.pl_description')}}" name="description" value="{{old('description')}}" required maxlength="190" type="text">
                  ...
                  <div id="key_feature_bag">
                    <div class="row">
                      <div class="col-md-10">
                       <div class="form-group">
                          <label class="content-label" id="key_feature_label">{{trans('subscriptions.key_features')}} (1/6)<span class="text-danger custom_asterisk">*</span></label>
                          <input class="form-control" placeholder="{{trans('subscriptions.pl_key_features')}}" name="key_features[]" value="{{old('key_features[0]')}}" required maxlength="50" type="text">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <input class="form-control" placeholder="{{trans('subscriptions.no_of_free_avatars')}}" name="no_of_free_avatars" value="{{old('no_of_free_avatars')}}" required type="number" maxlength="4" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" id="no_of_free_avatars" max="9999">
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <select class="form-control" name="price_per" id="price_per" required>
                          <option value="all">{{trans('subscriptions.please_select')}}</option>
                          <option value="day" @if(old('price_per') == 'day')selected @endif>{{trans('subscriptions.day')}}</option>
                          <option value="week" @if(old('price_per') == 'week')selected @endif>{{trans('subscriptions.week')}}</option>
                          <option value="month" @if(old('price_per') == 'month')selected @endif>{{trans('subscriptions.month')}}</option>
                          <option value="year" @if(old('price_per') == 'year')selected @endif>{{trans('subscriptions.year')}}</option>
                        </select>
                    ...
                    <div class="col-md-4">
                     <div class="form-group">
                        ...
                        <input class="form-control" placeholder="{{trans('subscriptions.validity')}}" name="validity" value="{{old('validity')}}" required type="number" maxlength="1" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" id="validity" max="6" min="1">
                  ...
                  <div class="row">
                    <div class="col-md-4">
                        <div class="form-group @error('color_code') ? has-error : ''  @enderror">
                          ...
                          <input class="form-control" minlength="2" maxlength="7" placeholder="{{trans('subscriptions.color_code')}}" name="color_code" type="color" value="{{  old('color_code') }}" required>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <select class="form-control" name="type" id="type" required>
                          <option value="all">{{trans('subscriptions.please_select')}}</option>
                          <option value="free" @if(old('type') == 'free')selected @endif>{{trans('subscriptions.free')}}</option>
                          <option value="paid" @if(old('type') == 'paid')selected @endif>{{trans('subscriptions.paid')}}</option>
                        </select>
                        @if ($errors->has('type')) 
                    ...
                    <div class="col-md-4">
                     <div class="form-group">
                        ...
                        <input class="form-control" placeholder="{{trans('subscriptions.price')}}" name="price" value="{{old('price')}}" required type="number" maxlength="8" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" id="price">
                          @if ($errors->has('price')) 
                  ...
                  <h4 class="card-title">
                 {{trans('subscriptions.benefits')}}<span class="text-danger custom_asterisk">*</span>
                  </h4>
                  <br/>
                  <div class="row">
                    ...
                    <div class="col-md-3">
                      <div class="form-group">
                        <label class="content-label">
                          <input type="checkbox" value="{{$benefit->id}}" name="permissions[]">
                        {{$benefit->title}}</label>
                      </div>
                    </div>
                    @endforeach
