                ...
                <div class="col-12">
                    ...
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">{{ trans('wish_return.plural') }}
                            </li>
                        </ol>
                    </div>
                </div>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title">{{ trans('wish_return.title') }}</h4>
              </div>
                    ...
                    <table class="table zero-configuration data_table_ajax">
                      <thead>
                        <tr>
                          ...
                          <th>{{trans('wish_return.product_id')}}</th>
                          <th>{{trans('wish_return.product_name')}}</th>
                          <th>{{trans('wish_return.product_image')}}</th>
                          <th>{{trans('wish_return.mrp')}}</th>
                          <th>{{trans('wish_return.sale_price')}}</th>
  ...
  $(document).ready(function(){
    ...
    function fill_datatable() {
        ...
        return meta.row + meta.settings._iDisplayStart + 1;
           ...
           { data: 'wish_return_qty',orderable: false},
           {
