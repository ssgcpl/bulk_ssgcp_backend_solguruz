    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0">{{trans('wish_return.show')}} </h2>
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{route('home')}}">{{ trans('common.home') }}</a>
                            </li>
                            <li class="breadcrumb-item"><a href="{{route('wish_return.show',$_GET['product_id'])}}">{{ trans('wish_return.show') }}</a></li>
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              ...
              @can('customer-list')
                <a href="{{route('wish_return.show',$_GET['product_id'])}}" class="btn btn-success">
