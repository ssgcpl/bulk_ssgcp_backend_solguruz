                ...
                <div class="col-12">
                    ...
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">{{ trans('avatars.update') }}
                            </li>
                        </ol>
                    </div>
                </div>
        ...
        <div class="col-12">
          <div class="card">
            ...
            <div class="card-content">
              <div class="card-body">    
                <form method="POST" id="categoryForm" action="{{route('avatars.update',$avatars->id)}}" accept-charset="UTF-8" enctype="multipart/form-data" >
                      ...
                      <div class="row">
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <select class="form-control" name="type" id="type" required>
                                ...
                                <option value="free" @if($avatars->type == 'free')selected @endif>{{trans('avatars.free')}}</option>
                                <option value="paid" @if($avatars->type == 'paid')selected @endif>{{trans('avatars.paid')}}</option>
                              </select>
                              @if ($errors->has('type')) 
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <input class="form-control" minlength="1" maxlength="8" placeholder="{{trans('avatars.price')}}" name="price" type="number" value="{{old('price') ? old('price') : $avatars->price }}" required oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"  id="price">
                              @if ($errors->has('price')) 
                          ...
                          <div class="col-md-12">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" placeholder="{{trans('avatars.name')}}" name="name" type="text" value="{{old('name') ? old('name') : $avatars->name}}" maxlength="50" required>
                              @if ($errors->has('name')) 
