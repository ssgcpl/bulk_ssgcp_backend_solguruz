                  ...
                  <div class="form-body">
                    <div class="row">
                          <div class="col-md-4" id="">
                            ...
                            <p class="add_new_category text-right"><i class="fa fa-plus"></i> Add New</p>
                            <input name="publish" type="checkbox" value="1" id="publish">&nbsp;&nbsp; Publish
                          </div>
                          <div class="col-md-8">
                            <div id="category_level_1">
                              <div class="form-group categories_levels_div" >
                                ...
                                @if ($errors->has('parent_id')) 
                                  <strong class="invalid-feedback">{{ $errors->first('parent_id') }}</strong>
                                @endif
                              </div>
                            </div> 
...
<script>
  ...
  $('#NestedCategoryForm').on('submit', function (e) {
          ...
          $.ajax({
                   url: "{{route('nested_categories.store')}}",
                   data: data,
                   type: "POST",
