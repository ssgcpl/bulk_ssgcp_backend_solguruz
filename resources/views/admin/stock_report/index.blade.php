    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0">{{ trans('stocks.stock_report_heading') }}</h2>
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{route('home')}}">{{ trans('common.home') }}</a>
                            </li>
                            <li class="breadcrumb-item active">{{ trans('stocks.stock_report_plural') }}
                            </li>
                        </ol>
                    </div>
                </div>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title">{{ trans('stocks.stock_report_heading') }}</h4>
                    ...
                    <table class="table zero-configuration data_table_ajax">
                      <thead>
                        <tr>
                          ...
                          <th>{{trans('stocks.return_qty')}}</th>
                          <th>{{trans('stocks.supplied_qty')}}</th>
                      ...
                      <tfoot>
                        <tr>
                          ...
                          <th>{{trans('common.id')}}</th>
                          <th>{{trans('products.product_image')}}</th>
                          <th>{{trans('products.sub_heading')}}</th>
                          <th>{{trans('products.sku_id')}}</th>
                          <th>{{trans('products.stock_status')}}</th>
                          <th>{{trans('products.mrp')}}</th>
                          <th>{{trans('products.dealer_sale_price')}}</th>
        ...
        columns: [
           ...
           { data: 'total_balance',orderable:false},
           {
            data: '',
                ...
                return '@can("stock-edit")<a class="" href="'+row["edit"]+'"><i class="fa fa-edit"></i></a>@endcan';
