    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0">{{ trans('orders.order_report') }}</h2>
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{route('home')}}">{{ trans('common.home') }}</a>
                            </li>
                            <li class="breadcrumb-item active">{{ trans('orders.order_report') }}
                            </li>
                        </ol>
                    </div>
                </div>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title">{{ trans('orders.order_report') }}</h4>

              </div>
              <div class="card-content">
                <div class="card-body card-dashboard">
                  <div class="row">
                    <div class="col-md-12 status_text d-none">
                  ...
                  <div class="row">
                    <div class="col-md-3">
                      <div class="form-group">
                        <label class="">{{trans('orders.payment_status')}}</label>
                        <select id="payment_status" class = "form-control" name='payment_status'>
                          <option value=''>{{trans('common.select')}}</option>
                          <option value="paid">{{trans('orders.paid')}}</option>
                          <option value="pending">{{trans('orders.pending')}}</option>
                          <option value="failed">{{trans('orders.failed')}}</option>
                        </select>
                      </div>
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                      <div class="form-group">
                        <label class="">{{trans('orders.order_by')}}</label>
                  ...
                  <div class="table-responsive">
                    <table class="table zero-configuration data_table_ajax" id="order_tbl" width="100%">
                      ...
                      <thead>
                        <tr>
                          ...
                          <th>{{trans('orders.payment_status')}}</th>
                          <th>{{trans('orders.placed_at')}}</th>
  ...
  $(document).ready(function(){
    ...
    function fill_datatable() {
        ...
        columns: [
           ...
           { data: 'placed_at',orderable: false},
           {
            data: '',
                mRender : function(data, type, row) {

                return '@can("order-edit")<a class="" title="Order details" target="_blank" href="'+row["edit"]+'"><i class="fa fa-eye"></i></a>@endcan';
    ...
    $('#order_type,#order_status,#user_type,#print_status,#payment_status').on('change', function(){
      fill_datatable();
    });
