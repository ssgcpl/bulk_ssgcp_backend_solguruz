                ...
                <div class="col-12">
                    ...
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">{{ trans('product_barcodes.plural') }}
                            </li>
                        </ol>
                    </div>
                </div>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title">{{ trans('product_barcodes.title') }}</h4>
              
                @can('product-create')
                  <div class="box-tools pull-right">
                    <a href="{{ route('product_barcodes.create') }}" class="btn btn-success pull-right">
                    {{ trans('product_barcodes.add_new') }}
                    </a>
                  </div>
                @endcan
              </div>
                      ...
                      <thead>
                        <tr>
                         <!--  <th><input type="checkbox" id="mark_all"></th> -->
                          <th>{{trans('product_barcodes.sr_no')}}</th>
                          <th>{{trans('product_barcodes.id')}}</th>
                         <!--  <th>{{trans('product_barcodes.product_id')}}</th> -->
                          <th width="15%">{{trans('product_barcodes.name_english')}}</th>
                          <th>{{trans('product_barcodes.sku_id')}}</th>
                          <th>{{trans('product_barcodes.created_date')}}</th>
                          <th>{{trans('product_barcodes.type')}}</th>
                          <th>{{trans('product_barcodes.total_barcode_qty')}}</th>
                      ...
                      <tfoot>
                        <tr>
                         <!--  <th></th> -->
                          ...
                          <th>{{trans('product_barcodes.id')}}</th>
                          <!-- <th>{{trans('product_barcodes.product_id')}}</th> -->
                          <th>{{trans('product_barcodes.name_english')}}</th>
                          <th>{{trans('product_barcodes.sku_id')}}</th>
                          <th>{{trans('product_barcodes.created_date')}}</th>
                          <th>{{trans('product_barcodes.type')}}</th>
                          <th>{{trans('product_barcodes.total_barcode_qty')}}</th>
