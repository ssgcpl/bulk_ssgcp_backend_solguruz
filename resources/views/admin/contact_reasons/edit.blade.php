        ...
        <div class="col-12">
          <div class="card">
            ...
            <div class="card-content">
              <div class="card-body">    
                <form id="stateForm" method="POST" action="{{route('contact_reasons.update',$reason->id)}}" accept-charset="UTF-8" enctype="multipart/form-data">
                      ...
                      <div class="col-md-12">  
                        <div class="form-group">
                          <label for="name" class="content-label">{{trans('reasons.reason_title')}}<span class="text-danger custom_asterisk">*</span></label>
                           <input class="form-control" minlength="2" maxlength="150" placeholder="{{trans('reasons.reason_title')}}" name="reason_title" type="text" value="{{old('reason_title') ? old('reason_title') : $reason->reason_title }}" required>
                            @error('reason_title')
