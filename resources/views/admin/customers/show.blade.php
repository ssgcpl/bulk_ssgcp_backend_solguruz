                  ...
                  @if($customer->user_type == 'dealer')
                    ...
                    <!-- <div class="row">
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group">
                           <select id="retailer_id" name="retailer_id" class="form-control selectpicker" data-live-search="true">
                            <option data-tokens='' value=''>{{trans('customers.select_retailer')}}</option>
                            @foreach($retailers as $retailer)
                            <option data-tokens='{{$retailer->first_name}}' value='{{$retailer->id}}'>{{$retailer->first_name}}</option>
                            @endforeach
                          </select>
                            </div>  </div>
                          <div class="col-md-6">
                             <label for="add_retailers" class="content-label"><h2></h2><span class="text-danger custom_asterisk"></span></label>
                             <button type="button" id="add_retailers_btn" class="btn btn-success">Add Retailer</button>
                          </div>
                     </div> -->
                    @else 
                    <div class="card">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row">
                       <div class="col-md-12">
                       <div class="form-group">
                          <label for="add_retailers" class="content-label"><h4>{{trans('customers.add_retailers')}}</h4><span class="text-danger custom_asterisk"></span></label><br>
                           <select id="retailer_id" name="retailer_id" class="form-control selectpicker" data-live-search="true">
