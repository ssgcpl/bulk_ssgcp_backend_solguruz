...
{   
    ...
    {   
        ...
        return [
            ...
            'mrp'                  => $this->wish_list ? $this->wish_list->product ? (string)floor($this->wish_list->product->mrp) :'' :'',
            'sale_price'           => $this->wish_list ? $this->wish_list->product ? (string)floor($this->wish_list->product->get_price($this->wish_list->user)) :'' :'',
