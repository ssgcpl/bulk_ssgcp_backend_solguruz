            ...
            <form id="signupForm" method="post" enctype="multipart/form-data">
                                ...
                                <div class="box">                        
                                    ...
                                    <div class="upload-img">
                                        ...
                                        <label class="file-input-label" for="company_images">
                                            <img src="{{asset('web_assets/images/upload-comp-img.png')}}" alt="">
                                            Add Image
                                        </label>
                                    </div>
                                </div>
                ...
                <div class="mb-3">
                    <div class="common-check my-3">
                        <label class="checkbox">I agree to the <a href="{{route('terms_and_condition')}}" title="">Terms & Conditions</a>
                        <input type="checkbox" id="terms" name="terms" required /><span class="checkmark"></span>
                       </label>
                        <!-- <label class="checkbox">I agree to the <a href="{{route('terms_and_condition')}}" target="_blank" title="">Terms & Conditions</a>
                ...
                <div class="signup-detail mt-4">
                    <p class="mb-0">Already have an account? <a href="{{route('signin')}}" class="clr-primary">Sign in</a></p>  
                </div> 
