...
<body>
	<form method="post" name="customerData" action="{{route('initiate_payment')}}">
		@csrf
		<table width="40%" height="100" border='1' align="center"><caption><font size="4" color="blue"><b>Integration Kit</b></font></caption></table>
			<table width="40%" height="100" border='1' align="center">
				...
				<tr>
					<td>Redirect URL	:</td><td><input type="text" name="redirect_url" value="{{route('payment_callback')}}"></td>
				</tr>
			 	<tr>
			 		<td>Cancel URL	:</td><td><input type="text" name="cancel_url" value="{{route('payment_callback')}}"></td>
			 	</tr>
			 	<tr>
