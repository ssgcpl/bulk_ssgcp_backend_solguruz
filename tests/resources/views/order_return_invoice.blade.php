...
<body style="margin: 0; font-size: 16px; font-family: 'Arabic', sans-serif; padding: 20px; -webkit-print-color-adjust: exact !important;">
    @foreach($data_array as $key=>$data)
    @if($key > 0)
        <div class="page-break"></div>
    @endif
 
        <table border="0" bgcolor="#ffffff" cellspacing="0" cellpadding="0" style="width: 1000px;margin: 0 auto;text-align: center;padding: 10px 0;border: 2px solid #f1f1f1;">
            <tbody>
                <tr>
                    <td>
                        ...
                        <table width="100%" style="padding:10px 0" >
                            <tr>
                                <td style="text-align: left;padding: 0 24px; width:100%;vertical-align:top;"> 
                                    ...
                                    <p style="margin:5px 0;"><b>Order ID:</b> #{{$data['order_return_id']}}</p>            
                    ...
                    <td  style="text-align: left;padding: 0 24px;width: 50%;vertical-align:top;">
                        <table width="100%" class="items_table" style="  border-collapse: collapse;margin: 0px 0 20px;" border="1" bgcolor="#ffffff"  cellpadding="10">
                            ...
                            <tbody>
                                ...
                                @endforeach
                                <tr>                                
                                    <td class="items_table" align="center" colspan="8"><b>Total Weight: {{$data['total_weight']}}(Kg) </b></td> 
                                </tr>
                             <!--    <tr>                                
                             ...
                             <!--    <tr>                                
                                    ...
                                    <td class="items_table" align="right"><b>₹</b></td>
                                </tr> -->
                                <tr>                                
