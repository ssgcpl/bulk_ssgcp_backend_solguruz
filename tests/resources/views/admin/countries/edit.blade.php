                ...
                <div class="col-12">
                    ...
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">{{ trans('countries.edit') }}
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <form method="POST" id="CountryForm" action="{{route('country.update',$country->id)}}" accept-charset="UTF-8" enctype="multipart/form-data" >
                  ...
                  <div class="row">
                    <div class="col-md-12">
                     <div class="form-group">
                        ...
                        <input class="form-control @error('country_name') ? is-invalid : ''  @enderror" minlength="2" maxlength="255" placeholder="{{trans('countries.country_name')}}" name="country_name" value="{{old('country_name',$country->name)}}" required>
                          @error('country_name')
                    ...
                    <div class="col-md-12">
                     <div class="form-group">
                        ...
                        <input   class="form-control @error('country_code') ? is-invalid : ''  @enderror" placeholder="{{trans('countries.country_code')}}" name="country_code" value="{{old('country_code',$country->country_code)}}" required>
                          @error('country_code')
                            <div class="invalid-feedback">
                  ...
                  <div class="row">
                      <div class="col-md-3">
                        ...
                        <input class="form-control @error('flag') ? is-invalid : ''  @enderror" type="file" placeholder="{{trans('countries.flag')}}" accept=".jpg,.jpeg,.png" name="flag" value="{{old('flag')}}">
