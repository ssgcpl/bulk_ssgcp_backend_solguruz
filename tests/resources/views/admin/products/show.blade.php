              ...
              <div class="col-12">
                  ...
                  <div class="breadcrumb-wrapper col-12">
                      <ol class="breadcrumb">
                          ...
                          <li class="breadcrumb-item active">{{ trans('products.show') }}
                          </li>
                      </ol>
                  </div>
              </div>
                          ...
                          <div class="row" id="english_div">
                              ...
                              <div class="col-md-3">
                                <div class="form-group">
                                  ...
                                  <textarea class="form-control" disabled>{!!$product->description_english!!}</textarea>
                                </div>
                              </div>
                              <div class="col-md-3">
                                <div class="form-group">
                          ...
                          <div class="form-group">
                              <label for="weight"
                                  class="content-label">{{ trans('products.last_returnable_date') }}<span
                                      class="text-danger custom_asterisk">*</span></label><br>
                             <p class="details"> {{date("d-m-Y h:i A",strtotime($product->last_returnable_date))}}</p>
                          </div>
                        </div>
                        <div class="col-md-3">
                          <div class="form-group">
