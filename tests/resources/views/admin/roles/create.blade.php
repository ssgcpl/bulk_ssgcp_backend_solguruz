    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0">{{trans('roles.add_new')}}</h2>
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{route('home')}}">{{ trans('common.home') }}</a>
                            </li>
                            <li class="breadcrumb-item"><a href="{{route('roles.index')}}">{{trans('roles.plural')}}</a></li>
                            <li class="breadcrumb-item active">{{ucfirst(basename(Request::url()))}}
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                {!! Form::open(array('route' => 'roles.store','method'=>'POST')) !!}
                        ...
                        <div class="form-body">
                            <div class="row">
                                ...
                                <!-- <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="usr">{{trans('roles.role_title')}}</label>
