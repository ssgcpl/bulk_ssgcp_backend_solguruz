                ...
                <div class="col-12">
                    ...
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">{{ trans('stocks_transfer.update') }}
                            </li>
                        </ol>
                    </div>
                </div>
                     ...
                     <div class="row">
                       @if($stock_transfer->gto_in_no !='' && $stock_transfer->gto_in_qty !='')
                          ...
                          <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                              <div class="form-group">
                                  <input name="type"class="transfer_type" value="gto_out" id="gto_out_return" type="radio" checked> {{ trans('stocks_transfer.gto_out_return') }}
                              </div>
                          </div>
                          @endif
                          ...
                          <div class="col-md-4">
                              <div class="form-group">
                                  ...
                                  <input name="type" class="transfer_type" value="scrap_return" id="scrap_return" type="radio" checked> {{ trans('stocks_transfer.scrap_return') }}
                              </div>
                          </div>
                          @endif
                        </div>
                        ...
                        <div class="row" id="gto_in_div">
                          <div class="col-md-6">
                                  <div class="form-group ">
                                    ...
                                    <input class="form-control @error('gto_in_no') ? is-invalid : ''  @enderror" placeholder="{{trans('stocks_transfer.gto_in_no')}}" name="gto_in_no" type="number" value="{{$stock_transfer->gto_in_no}}" >
                          ...
                          <div class="col-md-6">
                                  <div class="form-group ">
                                    ...
                                    <input class="form-control @error('gto_in_qty') ? is-invalid : ''  @enderror" placeholder="{{trans('stocks_transfer.gto_in_qty')}}" name="gto_in_qty" id="gto_in_qty" type="number" value="{{$stock_transfer->gto_in_qty}}" >
                    ...
                    <div class="row" id="gto_out_div">
                        <div class="col-md-6">
                                <div class="form-group ">
                                  ...
                                  <input class="form-control @error('gto_out_no') ? is-invalid : ''  @enderror" placeholder="{{trans('stocks_transfer.gto_out_no')}}" name="gto_out_no" id="gto_out_no" type="number" value="{{$stock_transfer->gto_out_no}}" >
                        ...
                        <div class="col-md-6">
                                <div class="form-group ">
                                  ...
                                  <input class="form-control @error('gto_out_qty') ? is-invalid : ''  @enderror" placeholder="{{trans('stocks_transfer.gto_out_qty')}}" name="gto_out_qty" id="gto_out_qty" type="number" value="{{$stock_transfer->gto_out_qty}}" >
                    ...
                    <div class="row" id="scrap_div">
                        <div class="col-md-6">
                                <div class="form-group ">
                                  ...
                                  <input class="form-control @error('scrap_no') ? is-invalid : ''  @enderror" placeholder="{{trans('stocks_transfer.scrap_no')}}" name="scrap_no" id="scrap_no" type="number" value="{{$stock_transfer->scrap_no}}" >
                        ...
                        <div class="col-md-6">
                                <div class="form-group ">
                                  ...
                                  <input class="form-control @error('scrap_qty') ? is-invalid : ''  @enderror" placeholder="{{trans('stocks_transfer.scrap_qty')}}" name="scrap_qty" type="number" value="{{$stock_transfer->scrap_qty}}" >
    ...
    var product_id = $("#product_id").val();
     ...
     $('#createForm').submit(function(evt){
          ...
          var data = new FormData(form);
           ...
           var route = "{{route('stocks_transfer.update',':id')}}";
          route = route.replace(':id', '{{$stock_transfer->id}}');
