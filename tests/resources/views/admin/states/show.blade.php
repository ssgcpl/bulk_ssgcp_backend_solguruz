                ...
                <div class="col-12">
                    ...
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">{{ trans('states.show') }}
                            </li>
                        </ol>
                    </div>
                </div>
              ...
              <div class="card-body">    
                <form method="POST" id="StateForm" action="{{route('states.update',$state->id)}}" accept-charset="UTF-8" enctype="multipart/form-data" >
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-12">
                     <div class="form-group">
                         <label for="name" class="content-label">{{trans('countries.country_name')}}<span class="text-danger custom_asterisk">*</span></label>
