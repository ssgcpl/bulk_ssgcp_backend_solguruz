    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0">{{ trans('authors.admin_heading') }}</h2>
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{route('home')}}">{{ trans('common.home') }}</a>
                            </li>
                            <li class="breadcrumb-item active">{{ trans('authors.plural') }}
                            </li>
                        </ol>
                    </div>
                </div>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title">{{ trans('authors.title') }}</h4>
                @can('authors-create')
                  <div class="box-tools pull-right">
                    <a href="{{ route('authors.create') }}" class="btn btn-success pull-right">
                    ...
                    <table class="table zero-configuration data_table_ajax">
                      <thead>
                        <tr>
                          ...
                          @if(auth()->user()->can('authors-edit') || auth()->user()->can('authors-list') || user()->can('authors-delete')  )
    ...
    function fill_datatable() {
      ...
      $('.data_table_ajax').DataTable({
        ...
        language: {
              ...
              emptyTable: "{{trans('datatable.empty_author')}}",
              zeroRecords:"{{trans('datatable.no_author')}}",
            },
        ajax: {
            url: "{{route('dt_author')}}",
