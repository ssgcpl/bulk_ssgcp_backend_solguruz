                ...
                <div class="col-12">
                    ...
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">{{ trans('web_content.update') }}
                            </li>
                        </ol>
                    </div>
                </div>
        ...
        <div class="col-12">
          <div class="card">
            ...
            <div class="card-content">
              <div class="card-body">    
                <form method="POST" id="categoryForm" action="{{route('web_content.update',$content->id)}}" accept-charset="UTF-8" enctype="multipart/form-data" >
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-12">
                        <div class="form-group @error('content') ? has-error : ''  @enderror">
                          ...
                          <textarea class="form-control" placeholder="{{trans('web_content.content')}}" name="content" type="text" rows="4" required>{{old('content') ? old('content') : $description}}</textarea>
                      ...
                      <div class="col-md-6">
                        <div class="form-group @error('show_read_now_button') ? has-error : ''  @enderror">
                          ...
                          <input type="checkbox" name="show_read_now_button" id="show_read_now_button" value="1" @if($content->show_read_now_button == '1')checked @endif> 
                      ...
                      <div class="col-md-6" id="has_dynamic_link">
                        <div class="form-group @error('has_dynamic_link') ? has-error : ''  @enderror">
                          ...
                          <input type="checkbox" name="has_dynamic_link" id="link" value="1" @if($content->has_dynamic_link == '1')checked @endif> 
                      ...
                      <div class="col-md-12" id="dynamic_link" style="display: none"> 
                        <div class="form-group @error('dynamic_link') ? has-error : ''  @enderror">
                          ...
                          <input class="form-control" minlength="2" maxlength="190" placeholder="{{trans('web_content.dynamic_link')}}" name="dynamic_link" type="url" value="{{old('dynamic_link') ? old('dynamic_link') : $content->dynamic_link }}" id="url">
...
<script type="text/javascript">
  ...
  $('#show_read_now_button').on('click',function(){
