                ...
                <div class="col-12">
                    ...
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">{{ trans('wish_list.show') }}
                            </li>
                        </ol>
                    </div>
                </div>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title">{{ trans('wish_list.show') }}</h4>
                 @can('wish-list-list')
                <a href="{{route('wish_list.index')}}" class="btn btn-success">
                  ...
                  <div class="row">
                       <div class="col-md-2">
                          <div class="form-group">
                            ...
                            <option value="dealer">{{trans('wish_list.dealer') }}</option>
                            <option value="retailer">{{trans('wish_list.retailer') }}</option>
                            </select>
                          </div>
                      </div>
                    <div class="col-md-2">
                    ...
                    <table class="table zero-configuration data_table_ajax">
                      <thead>
                        <tr>
                          ...
                          <th>{{trans('wish_list.dealer_name')}}</th>
  ...
  $(document).ready(function(){
    ...
    function fill_datatable() {
        ...
        columns: [
           ...
           { data: 'wish_product_qty',orderable: true},
                  ...
                  return data;},orderable:true},
           {
                ...
                return '<a class="" href="'+row["show"]+'"><i class="fa fa-eye"></i></a>  @can("stock-delete")<form action="'+row["delete"]+'" id="form'+row["id"]+'" method="post"><a class=" delete_btn" href="javascript:void(0)" onclick=" return delete_alert('+row['id']+')"><i class="fa fa-trash"></i></a>@method("delete")@csrf</form>@endcan';
                 }
          },
          ]
    });
