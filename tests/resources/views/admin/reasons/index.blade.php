              ...
              <div class="card-header">
                ...
                @can('reason-create')
                  <div class="box-tools pull-right">
                    <a href="{{ route('reasons.create') }}" class="btn btn-success pull-right">
                    ...
                    <table class="table zero-configuration data_table_ajax">
                      <thead>
                        <tr>
                          ...
                          <th>{{trans('reasons.name')}}</th>
                          <th>{{trans('reasons.type')}}</th>
    ...
    function fill_datatable() {
      ...
      $('.data_table_ajax').DataTable({ 
        ...
        columns: [
           ...
           { data: 'ticket_type',orderable: false},
           { data: 'status',
...
*/                },orderable: false
           ...
           { 
              mRender : function(data, type, row) {
                return '@can("reason-edit")<a class="" href="'+row["edit"]+'"><i class="fa fa-edit"></i></a>@endcan <a class="" href="'+row["show"]+'"><i class="fa fa-eye"></i></a>@csrf</form>';
