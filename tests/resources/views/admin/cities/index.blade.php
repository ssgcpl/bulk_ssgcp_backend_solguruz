                ...
                <div class="col-12">
                    ...
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">{{ trans('cities.plural') }}
                            </li>
                        </ol>
                    </div>
                </div>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title">{{ trans('cities.title') }}</h4>
                @can('city-create')
                  <div class="box-tools pull-right">
                    <a href="{{ route('cities.create') }}" class="btn btn-success pull-right">
      ...
      $('.data_table_ajax').DataTable({
       ...
       /* scrollX: true,*/
        ...
        language: {
              ...
              emptyTable: "{{trans('datatable.empty_cities')}}",
              zeroRecords:"{{trans('datatable.no_cities')}}",
            },
        ajax: {
            url: "{{route('dt_cities')}}",
             ...
             { data: 'status',
                mRender : function(data, type, row) {
                 ...
                 if(status=='active'){
                  ...
                  return status_label+'<div class="custom-control custom-switch custom-switch-success mr-2 mb-1"><input type="checkbox"'+type+' + class="status custom-control-input" id="customSwitch'+row["id"]+'" data_id="'+row["id"]+'"><label class="custom-control-label" for="customSwitch'+row["id"]+'"></label></div>';
                  } 
              },
             { 
                mRender : function(data, type, row) {
                     return '<a class="" href="'+row["show"]+'"><i class="fa fa-eye"></i></a> <a class="" href="'+row["edit"]+'"><i class="fa fa-edit"></i></a>';
