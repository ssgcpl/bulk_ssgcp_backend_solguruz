                    ...
                    <div class="tab-pane fade show active" id="tab11" role="tabpanel" aria-labelledby="tab1">
                        <form id="loginPasswordForm">
                            ...
                            <div class="login-with justify-content-end">                                
                                <a href="<?php echo e(route('forgot_password')); ?>" title="" class="forgot">Forgot Password?</a>
                            </div>
                            <div class="signup-detail mt-4">
                                <p><a href="<?php echo e(route('web_home')); ?>" class="clr-primary"><u>Guest User</u></a></p>
                            </div>
                            <div class="mb-3">           
                                <button type="button" id="login_with_password" name="login_with_password" class="btn primary-btn w-100">Sign in</button>
                            </div> 
                            <div class="signup-detail mt-4">
                                <p>Don’t have an account? <a href="<?php echo e(route('signup')); ?>" class="clr-primary">Sign up</a></p>  
...
<?php echo $__env->make('customer.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/ssgc-bulk/resources/views/customer/auth/signin.blade.php ENDPATH**/ ?>