...
<script src="<?php echo e(asset('web_assets/js/bootstrap.bundle.js')); ?>"></script>
...
<!-- <script src="<?php echo e(asset('web_assets/js/page-scroll.js')); ?>"></script> -->
<script src="<?php echo e(asset('web_assets/js/intlTelInput.min.js')); ?>"></script>
<!-- <script src="js/utils.js"></script> -->
<script src="<?php echo e(asset('web_assets/js/main.js')); ?>"></script>

<!-- toastr js -->
<script src="<?php echo e(asset('web_assets/js/toastr.min.js')); ?>"></script>
...
</script><?php /**PATH /opt/lampp/htdocs/ssgc-bulk/resources/views/customer/elements/footer_links.blade.php ENDPATH**/ ?>