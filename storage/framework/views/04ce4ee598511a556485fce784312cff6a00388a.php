...
$(document).ready(function(){
	const BASE_URL = "<?php echo e(config('adminlte.base_api_url')); ?>";
  var interval;
  var token = '';
  var userid = '';
  var user_type = '';
  ...
  function auth_guard_route(token = '') {
        if(!token || token === "") {
          ...
          //location.href = "<?php echo e(route('signin')); ?>"+"?url="+window.location.href;
        }

        if(token == '401'){
          window.location ="<?php echo e(route('signin')); ?>";
  ...
  $(document).on('click',"#my_cart",function(e){
    ...
    if(token)
    {
      location.href = "<?php echo e(route('my_cart')); ?>";
    }
  });
  /* Common verify otp for signin,signup ::STARTS */
  <?php if(\Request::route()->getName() == 'signup' || \Request::route()->getName() == 'signin'): ?>
            ...
            $.ajax({
                ...
                success: function(response) {
                  ...
                  if(response.status == "200") {
                      ...
                      auth_guard_route(token);
                      <?php if(\Request::route()->getName() == 'signup'): ?>
                        location.href = "<?php echo e(route('web_home')); ?>?is_first=1";
                      <?php else: ?> 
                        location.href = "<?php echo e(route('web_home')); ?>";
                      <?php endif; ?>
  ...
  /* Common verify otp for signin,signup  :: ENDS*/
	...
	<?php if(\Request::route()->getName() == 'signin'): ?>
  ...
  <?php if(\Request::route()->getName() == 'forgot_password'): ?>
                ...
                success: function(response) {
                  if(response.status == "200") {
                    if($("input[name=sendoption]:checked").attr('id') == 'email_chk'){
                      ...
                      location.href ="<?php echo e(route('signin')); ?>";
                    }else {
                      countdown_timer();
    ...
    $('#verify_fpassword_otp').click(function(e){
            ...
            $.ajax({
                ...
                success: function(response) {
                  console.log(response);
                  if(response.status == "200") {
                    var route = "<?php echo e(route('reset_password')); ?>?otp="+otp+"&phone="+mobile_number;
                    location.href = route;
                    toastr.success(response.message);
                  } 
                  else 
  ...
  <?php if(\Request::route()->getName() == 'reset_password'): ?>
  ...
  <?php if(Request::route()->getName() == 'customer.profile'): ?>
  ...
  <?php endif; ?>
  <?php if(\Request::route()->getName() == 'customer.profile' || \Request::route()->getName() == 'books_checkout'): ?>
   ...
   /* setTimeout(function() {
      <?php if(\Request::input('add_address') == 'true'): ?>
  ...
  <?php if(\Request::route()->getName() == 'digital_coupons_list'): ?>
        var order_status  = [];
            ...
            success: function(response) {
                ...
                $.each(response.data,function(key,value){
                    if(this.order_status == 'Completed') {
                      var show_page = "<?php echo e(route('digital_coupon_detail_expired',':id')); ?>";
                          show_page = show_page.replace(':id',this.id);
                    }else {
                      var show_page = "<?php echo e(route('digital_coupon_detail_purchased',':id')); ?>";
                          show_page = show_page.replace(':id',this.id);
                    }
  ...
  <?php if(\Request::route()->getName() == 'digital_coupon_detail_purchased' || \Request::route()->getName() == 'digital_coupon_detail_expired'): ?>
                ...
                if(response.status == "200") {
                  ...
                  $.each(response.data.coupon_items,function(index,value){
                      ...
                      if(index == 0) { 
                   	...
                   	<?php if(\Request::route()->getName() == 'digital_coupon_detail_purchased'): ?> 
  ...
  <?php if(\Request::route()->getName() == 'refer_earn'): ?>
                        ...
                        if(type == 'history'){
                          ...
                          $.each(response.data.data, function(){
                              ...
                              html_history += `<div class="list">
                                ...
                                html_history += ` <div class="list">
                                              <div class="box">
                                                <div class="img"><img src="<?php echo e(asset('web_assets/images/earning-point.svg')); ?>" alt=""></div>
                                                <div class="detail">
  ...
  /* ################# HOME :: SCRIPT STARTS ################# */
      <?php if(\Request::route()->getName() == 'web_home'): ?>
        if(token !== null){
        ...
        $.ajax({
            ...
            success: function(response) {
                if(response.status == "200") {
                    ...
                    $.each(response.data,function(key,value){
                      if(this.type == "books"){
                        var link = "<?php echo e(route('books_list',':cat_id')); ?>";
                      ...
                      else
                      {
                        ...
                        // var link = "<?php echo e(route('latest_digital_coupons')); ?>";
                        var link = "<?php echo e(route('latest_digital_coupons',':cat_id')); ?>";
                        link = link.replace(':cat_id',value.id);
                        $('#business_categories_div').append('<li><a href="'+link+'" title=""><div class="box"><img src="'+value.image+'" alt=""></div><p>'+value.name+'</p></a></li>');
                      }
                    ...
                    if(localStorage.getItem("user_token") !== null)
                    {
                      var link = "<?php echo e(route('make_my_return')); ?>";
                      $('#business_categories_div').append('<li><a href="'+link+'" title=""><div class="box"><img src="<?php echo e(asset("web_assets/images/cat2.svg")); ?>" alt=""></div><p>My Return</p></a></li>');
                    }
            ...
            success: function(response) {
                if(response.status == "200") {
                    ...
                    $.each(response.data, function (key,category) {
                      ...
                      {
                        var view_all_link = "<?php echo e(route('books_list',':cat_id')); ?>";
                        view_all_link = view_all_link.replace(':cat_id',category.business_category_id);
                        
                      }
                      else
                      {
                        // var view_all_link = "<?php echo e(route('latest_digital_coupons')); ?>";
                        var view_all_link = "<?php echo e(route('latest_digital_coupons',':cat_id')); ?>";
                        view_all_link = view_all_link.replace(':cat_id',category.business_category_id);
                      ...
                      $.each(category.list, function (key,value) {
                        if(key < 6)
                        {
                          if(category.type == 'books')
                          {
                            var detail_url = "<?php echo e(route('book_detail',':book_id')); ?>";
                            detail_url = detail_url.replace(':book_id',value.product_id);
                          }
                          else
                          {
                            var detail_url = "<?php echo e(route('digital_coupon_details',':coupon_id')); ?>";
                            detail_url = detail_url.replace(':coupon_id',value.product_id);
                          }
                          if(value.added_to_cart == '1')
                          {
                            var view_cart = "<?php echo e(route('my_cart')); ?>";
                    ...
                    else
                    {
                      $.each(response.data, function (key,value) {
                        if(key < 3)
                        {
                          ...
                          var book_detail_url = "<?php echo e(route('book_detail',':book_id')); ?>";
        ...
        if(token !== null)
        {
           ...
           function change_view_all_link(active_tab){
              if(active_tab == 'tab1'){
                $("#my_return_view_all").attr('href','<?php echo e(route("make_my_return")); ?>');
              }else if(active_tab == 'tab2'){
                $("#my_return_view_all").attr('href','<?php echo e(route("return_products_list")); ?>');
              }
           }
                  ...
                  if(response.status == "200") {
                      ...
                      $.each(response.data.returnable_books,function(key,value){
                        if(key < 6)
                        {
                          if(value.added_to_cart == '1')
                          {
                            var return_cart_btn = `<a href="<?php echo e(route('return_cart')); ?>" class="btn green-btn">View Return Cart <i class="icon-bag"></i></a>`;
                          }
                          else
                          {
                      ...
                      $.each(response.data.previous_orders,function(key,value){
                        if(key <= 4)
                        {
                          ...
                          { 
                            ...
                            return_product_url = "<?php echo e(route('return_placed',':id')); ?>";
                          ...
                          {  
                            ...
                            return_product_url = "<?php echo e(route('return_dispatched',':id')); ?>";
                            return_product_url = return_product_url.replace(':id',value.order_return_id);
                          }
                          else if(this.status == 'rejected')
                          { 
                            span_class ='theme-red-color';  
                            return_product_url = "<?php echo e(route('return_rejected',':id')); ?>";
                            return_product_url = return_product_url.replace(':id',value.order_return_id);
                          }
                          else if(this.status == 'accepted')
                          {
                            span_class ='green-color';  
                            return_product_url = "<?php echo e(route('return_accepted',':id')); ?>";
                            return_product_url = return_product_url.replace(':id',value.order_return_id);
                          }
  ...
  /* ################# SEARCH :: SCRIPT ENDS ################# */
    /*  $(document).on("input","#keyword",function(){
          ...
          if($("#keyword").val().length > 2){
            ...
            window.location.href = "<?php echo e(route('search')); ?>?q="+query+"&type="+type
          }
          else {
      ...
      <?php if(\Request::route()->getName() == 'search'): ?>
        ...
        {
          var search_string = "<?php echo e(app('request')->input('q')); ?>";
          var search_type = "<?php echo e(app('request')->input('type')); ?>";
                      ...
                      else
                      {
                        ...
                        $.each(response.data,function(key,value){
                          ...
                          if(search_type == 'books')
                          {
                            ...
                            var book_detail_url = "<?php echo e(route('book_detail',':book_id')); ?>?lang="+value.language;
  ...
  /* ################# BOOK LIST :: SCRIPT STARTS ################# */
      <?php if(\Request::route()->getName() == 'books_list'): ?>
        var page        = 1;
        var last_page   = '';
                  ...
                  if(response.status == "200") {
                      ...
                      else
                      {
                        ...
                        $.each(response.data,function(key,value){
                          ...
                          var book_detail_url = "<?php echo e(route('book_detail',':book_id')); ?>?lang="+language;
                          book_detail_url = book_detail_url.replace(':book_id',value.book_id);
  ...
  /* ################# TRENDING BOOK LIST :: SCRIPT STARTS ################# */
      <?php if(\Request::route()->getName() == 'trending_books'): ?>
        var page        = 1;
        var last_page   = '';
  ...
  /* ################# MAKE MY RETURN LIST :: SCRIPT STARTS ################# */
      <?php if(\Request::route()->getName() == 'make_my_return'): ?>
        var page        = 1;
        var last_page   = '';
        var tab_changed ;
        var category_id = $("li.breadcrumb").last().attr('name');
                  ...
                  if(response.status == "200") {
                      ...
                      else
                      {
                        ...
                        $.each(response.data,function(key,value){
                          ...
                          if(value.added_to_cart == '1')
                          {
                            var cart_btn = `<a href="<?php echo e(route('return_cart')); ?>" class="btn green-btn">View Return Cart <i class="icon-bag"></i></a>`;
                          }
                          else
                          {
  ...
  /* ################# BOOK DETAIL :: SCRIPT STARTS ################# */
      <?php if(\Request::route()->getName() == 'book_detail'): ?>
          function nl2br (str, is_xhtml) {   
              var breakTag = (is_xhtml || typeof is_xhtml === 'undefined') ? '<br />' : '<br>';    
              return (str + '').replace(/([^>\r\n]?)(\r\n|\n\r|\r|\n)/g, '$1'+ breakTag +'$2');
          }
          var book_id = $("#book_id").val();
          var language = "<?php echo e(app('request')->input('lang')); ?>";
          $.ajax({
              ...
              success: function(response) {
                  if(response.status == '201'){
                    ...
                    $(".book-price-weight").html(`<ul>
                        <li><label><img class="rupee" src="<?php echo e(asset('web_assets/images/book-price.svg')); ?>" alt=""> Book Price</label><div class="price">₹ `+book.sale_price+`<span>₹ `+book.mrp+`</span></div></li>                
          ...
          $(document).on('click','.add_to_cart_book_detail',function(){
              ...
              $.ajax({
                ...
                success: function(response) {
                  ...
                  if(response.status == "200") {
                   // toastr.success(response.message);
                    $("#add_more_btn_detail").attr('href',"<?php echo e(route('search')); ?>?type=books");
  ...
  /* ################# MY ORDERS :: SCRIPT STARTS ################# */
      <?php if(\Request::route()->getName() == 'my_orders'): ?>
        var page        = 1;
        var last_page   = '';
        var order_status = '';
                  ...
                  if(response.status == "200") {
                      ...
                      else
                      {
                        ...
                        $.each(response.data,function(key,value){
                          ...
                          var order_detail_url = "<?php echo e(route('order_details',':id')); ?>";
  ...
  /* ################# ORDER DETAIL :: SCRIPT STARTS ################# */
      <?php if(\Request::route()->getName() == 'order_details'): ?>
              ...
              success: function(response) {
                  ...
                  if(response.status == "200") {
                    ...
                    $(order.book_items).each(function(){
                      var order_book_view_url = "<?php echo e(route('order_book_view',':order_item_id')); ?>?lang="+this.language;
                      ...
                      if(order.order_status == 'Completed')
                      {
                        ...
                        {
                          return_product_btn = `<a href="<?php echo e(route('return_cart')); ?>" class="btn green-btn">View Return Cart <i class="icon-bag"></i></a>`;
                        }
                      }
                      ...
                      if(this.stock_status == 'out_of_stock')
                      {
                        ...
                        var create_wishlist_url = "<?php echo e(route('create_wishlist',':book_id')); ?>";
                        ...
                        var wishlist_cart_btn = `<a href="`+create_wishlist_url+`?qty=`+this.quantity+`" class="btn secondary-btn create_wishlist_btn" >Add to Wishlist</a>`;
                          ...
                          var wishlist_url = "<?php echo e(route('wishlist')); ?>?t=my_wishlist";
                      ...
                      else
                      {
                        ...
                        {
                          var wishlist_cart_btn = `<a href="<?php echo e(route('my_cart')); ?>" class="btn secondary-btn">View Cart</a>`;
                        }
            ...
            $.ajax({
              ...
              success: function(response) {
                if(response.status == "200") {
                  ...
                  setTimeout(function(){
                   // location.href = "<?php echo e(route('wishlist')); ?>?t=my_wishlist";
                   location.reload();
                  },1000);
                }
                else {
              ...
              $.ajax({
                ...
                success: function(response) {
                  ...
                  if(response.status == "200") {
                    toastr.success(response.message);
                    <?php if(\Request::route()->getName()=="order_details"): ?>
                     var view_cart_link = "<?php echo e(route('my_cart')); ?>";
  ...
  /* ################# ORDER BOOK VIEW :: SCRIPT STARTS ################# */
      <?php if(\Request::route()->getName() == 'order_book_view'): ?>
          var order_item_id = $("#order_item_id").val();
          var book_id = $("#book_id").val();
          var language = "<?php echo e(app('request')->input('lang')); ?>"; 
          var order_item_info;
                ...
                if(response.data)
                {
                  order_item_info = response.data;
                   // var book = response.data;
                        ...
                        $(".book-price-weight").html(`<ul>
                            <li><label><img class="rupee" src="<?php echo e(asset('web_assets/images/book-price.svg')); ?>" alt=""> Book Price</label><div class="price">₹ `+order_item_info.sale_price+`<span>₹ `+order_item_info.mrp+`</span></div></li>                
  ...
  /* ################# RETURN CART :: SCRIPT STARTS ################# */
      <?php if(\Request::route()->getName() == 'return_cart'): ?>
          var return_items = []
          $.ajax({
                      ...
                      else
                      {
                        ...
                        $('#return_products').html(`<div class="section-title justify-content-center"><h2>Return Product Cart</h2></div> 
                            ...
                            <div class="text-center mt-4">
                              <a href="<?php echo e(route('make_my_return')); ?>" class="btn secondary-btn me-1">Add More</a>
            ...
            $.ajax({
                ...
                success: function(response) {
                    if(response.status == "200") {
                      toastr.success(response.message);
                      setTimeout(function(){
                        location.href = "<?php echo e(route('return_products_list')); ?>";
                      },1000);
                    }
                    else {
                      toastr.error(response.message);
  ...
  /* ################# WISHLIST :: SCRIPT STARTS ################# */
      <?php if(\Request::route()->getName() == 'wishlist'): ?>
          auth_guard_route(token);
          var page        = 1;
          var last_page   = '';
          var tab = "<?php echo e(app('request')->input('t')); ?>";
            ...
            $.ajax({
                ...
                success: function(response) {
                  if(response.status == "200") {
                    toastr.success(response.message);
                    setTimeout(function(){
                      location.href = "<?php echo e(route('wishlist')); ?>?t=available";
                    },1000);
      ...
      <?php if(\Request::route()->getName() == 'create_wishlist'): ?>
          auth_guard_route(token);
  ...
  /* ################# WISH RETURN :: SCRIPT STARTS ################# */
      <?php if(\Request::route()->getName() == 'wish_return'): ?>
          auth_guard_route(token);
          var page        = 1;
          var last_page   = '';
          var category_id = $("li.breadcrumb").last().attr('name');
                    ...
                    if(response.status == "200") {
                        ...
                        else
                        {
                          ...
                          $.each(response.data,function(){
                            ...
                            if(type == 'all_wish_return')
                            {
                              var wish_return_product_url = "<?php echo e(route('wish_return_product',':book_id')); ?>";
                            ...
                            {
                              var edit_wish_return_url = "<?php echo e(route('edit_wish_return',':wish_return_id')); ?>";
            ...
            $.ajax({
                ...
                success: function(response) {
                  if(response.status == "200") {
                    toastr.success(response.message);
                    setTimeout(function(){
                      location.href = "<?php echo e(route('wish_return')); ?>?t=my_wish_return";
                    },1000);
      ...
      <?php if(\Request::route()->getName() == 'wish_return_product'): ?>
          auth_guard_route(token);
          ...
          $(document).on('click','#select_dealer_btn',function(){
            ...
            $("#selected_dealer").html(`<a href="#" title="" data-bs-toggle="modal" data-bs-target="#select-dealer">`+dealer_name+` <img src="<?php echo e(asset('web_assets/images/right-arrow.svg')); ?>" alt=""></a>`)
          });
      ...
      <?php if(\Request::route()->getName() == 'edit_wish_return'): ?>
          auth_guard_route(token);
          
          var wish_return_id = "<?php echo e($wish_return_id); ?>";
          //get dealers list
          $.ajax({
  ...
  <?php if(\Request::route()->getName() == 'retailer_wish_list'): ?>
      var page = 1;
      var last_page   = '';
      load_more(page); 
          ...
          $.ajax({
            ...
            success: function(response) {
                if(response.status == "200") {
                 var html ='';
                 $.each(response.data,function(){
                    var show_page = "<?php echo e(route('request_wishlist_detail',':wish_list_request_id')); ?>";
  ...
  <?php if(\Request::route()->getName() == 'request_wishlist_detail'): ?>
  ...
  <?php if(\Request::route()->getName() == 'retailer_wish_return'): ?>
      var page = 1;
      var last_page = '';
      load_more(page); 
          ...
          $.ajax({
            ...
            success: function(response) {
                if(response.status == "200") {
                 var html ='';
                 $.each(response.data,function(){
                    var show_page = "<?php echo e(route('request_wishreturn_detail',':wishreturn_request_id')); ?>";
  ...
  <?php if(\Request::route()->getName() == 'request_wishreturn_detail'): ?>
  ...
  <?php if(\Request::route()->getName() == 'return_products_list'): ?>
	        ...
	        success: function(response) {
              ...
              else
              {
                ...
                $.each(response.data, function(){
                  ...
                  { 
                    span_class ='orange-color';  
                    show_page = "<?php echo e(route('return_placed',':id')); ?>";
                  ...
                  {  
                    span_class ='text-warning';  
                    show_page = "<?php echo e(route('return_dispatched',':id')); ?>";
                    show_page = show_page.replace(':id',this.order_return_id);
                  }
                  else if(this.status == 'rejected')
                  { 
                    span_class ='theme-red-color';  
                    show_page = "<?php echo e(route('return_rejected',':id')); ?>";
                    show_page = show_page.replace(':id',this.order_return_id);
                  }
                  else if(this.status == 'accepted')
                  {
                    span_class ='green-color';  
                    show_page = "<?php echo e(route('return_accepted',':id')); ?>";
                    show_page = show_page.replace(':id',this.order_return_id);
                  }
  ...
  <?php if(\Request::route()->getName() == 'return_dispatched'): ?>
  ...
  <?php if(\Request::route()->getName() == 'return_accepted'): ?>
  ...
  <?php if(\Request::route()->getName() == 'return_rejected'): ?>
  ...
  <?php if(\Request::route()->getName() == 'return_placed'): ?>
  ...
  <?php if(\Request::route()->getName()=='suggestions' || \Request::route()->getName() =='latest_digital_coupons' || \Request::route()->getName() =='books_list' || \Request::route()->getName() =='wish_return'): ?>
      var active_tab = '';
      var tab_changed = 0;
      ...
      var call_action = '';
      <?php if(\Request::route()->getName()=='suggestions'): ?>
        $("#product_list").html("");
        call_action = 'suggestions';
      <?php elseif(\Request::route()->getName()=='latest_digital_coupons'): ?>
        $("#digital_coupons_list").html('');
        call_action = 'latest_digital_coupons';
      <?php elseif(\Request::route()->getName()=='books_list' || \Request::route()->getName()=='make_my_return'): ?>
        $('#books_list').html("");
        $('#books_list_hindi').html("");
        call_action = 'books_list';
      <?php elseif(\Request::route()->getName()=='wish_return'): ?>
        var tab = "<?php echo e(app('request')->input('t')); ?>";
        if(tab != 'my_wish_return')
        {
          $('#all_wish_return_data_hindi').html("");
  ...
  <?php if(\Request::route()->getName() == 'latest_digital_coupons'): ?>
      var page = 1;
      var last_page = '';
              ...
              if(response.status == "200") {
                ...
                $.each(response.data,function(){
                  ...
                  if(this.added_to_cart == '0'){
                   ...
                   var show_page = "<?php echo e(route('digital_coupon_details',':id')); ?>";
  ...
  <?php endif; ?>
  <?php if(\Request::route()->getName() == 'digital_coupon_details'): ?>
  ...
  <?php if(\Request::route()->getName() == 'latest_digital_coupons' || \Request::route()->getName() == 'digital_coupon_details'): ?>
    $(document).on('click','.add_to_cart',function(){
          auth_guard_route(token);
          var coupon_id = $(this).attr('id');
          <?php if(\Request::route()->getName() == 'latest_digital_coupons'): ?>
  ...
  <?php if(\Request::route()->getName() == 'my_cart' || \Request::route()->getName() == 'coupons_checkout' || \Request::route()->getName() == 'books_checkout'): ?>

    auth_guard_route(token);
    var checkout_items = [];

    <?php if(\Request::route()->getName() == 'my_cart'): ?>
      var urlParams = new URLSearchParams(window.location.search);
        ...
        success: function(response) {
          if(response.status == "200") {
            ...
            if(response.data.coupon_items.length > 0)
            {
              ...
              $("#add_more_btn").attr('href',"<?php echo e(route('search')); ?>?type=coupons");
            }
            else if(response.data.book_items.length > 0)
            {
              $(".no-data-found").addClass('d-none');
              $("#cart_data").removeClass('d-none');
              <?php if(\Request::route()->getName() == 'books_checkout'): ?>
              ...
              var check_items = "[<?php echo e($check_items); ?>]";
              ...
              $("#add_more_btn").attr('href',"<?php echo e(route('search')); ?>?type=books");
            }
            else {
	          ...
	          items += `<div class="cart-list white-bg"><!--<div class="top-check-list">
	                  ...
	                  <div class="box">
	                    ...
	                    <a href="`+show_page+`"><h5>`+this.name+`</h5></a>
                          ...
                          <?php if(\Request::route()->getName() =='coupons_checkout'): ?> 
    ...
    function set_book_items(data){
      ...
      $.each(data,function(){
        ...
        var show_page = "<?php echo e(route('book_detail',':id')); ?>";
    ...
    function set_book_items_for_checkout(data){
      ...
      ?>
      var checkout_items = "[<?php echo e($checkout_items); ?>]";
    ...
    function cart_summary(data,total_items,order_type,user_type){
      ...
      if(data)
      {
        if(order_type == 'coupon')
        {
          ...
          var checkout_url = "<?php echo e(route('coupons_checkout')); ?>";
        }
        ...
        if(order_type == 'book')
        {
          ...
          var checkout_url = "<?php echo e(route('books_checkout')); ?>?chk_items="+selected_items;
    ...
    <?php if(\Request::route()->getName() == 'books_checkout'): ?>
      ...
      $(document).on('click','#place_order',function(){
            ...
            success: function(response) {
              ...
              if(response.status == "200") {
               ...
               // toastr.error(response.message);
                ...
                setTimeout(function(){ location.href="<?php echo e(route('my_cart')); ?>" },1000);
              }
              else {
                toastr.error(response.message);
              }
        ...
        else
        {
          $.ajax({
            ...
            success: function(response) {
              if(response.status == "200") {
                location.href = "<?php echo e(route('order_payment_success')); ?>";
              }
              else if(response.status == "201") {
                //location.href = "<?php echo e(route('order_payment_success')); ?>";
                toastr.error(response.message);
               ...
               // toastr.error(response.message);
                ...
                location.href = "<?php echo e(route('order_payment_error')); ?>";
              }
              $('.loader').css('visibility','hidden');
            }
          });
     ...
     /*
      $(document).on('click','.add_new_address',function(){
        location.href = "<?php echo e(route('customer.profile')); ?>?add_address=true";
      });*/
    <?php endif; ?>
  <?php endif; ?>
  <?php if(Request::is('order_payment_success')): ?>
    var type = "<?php echo e(app('request')->input('type')); ?>";
    setTimeout(function() {
      if(type == 'coupon')
      {
        $("#redirect_url").attr('href',"<?php echo e(route('digital_coupons_list')); ?>")
      }
      $("#place-order").modal('show');
    },500);
    
  <?php endif; ?>
  <?php if(Request::is('order_payment_error')): ?>
    //redirect to cart
    location.href = "<?php echo e(route('my_cart')); ?>"
  <?php endif; ?>
  ...
  /*################# NOTIFICATIONS :: SCRIPT STARTS #################*/
    $(document).on('click',"#notification",function(e){
      ...
      if(token)
      {
        location.href = "<?php echo e(route('notifications')); ?>";
      }
    });
    <?php if(\Request::route()->getName() == 'notifications'): ?>
          auth_guard_route(token)
          var page = 1;
          var last_page ;
          load_more(page);
                  ...
                  if(response.status == "200") {
                    ...
                    else
                    {
                      ...
                      $.each(response.data,function(){
                        ...
                        {
                          var route  = "<?php echo e(route('ticket_history')); ?>?ticket_id="+this.data_id;
                        }
                          ...
                          var route  = "<?php echo e(route('order_details',':id')); ?>";
                          ...
                          var route  = "<?php echo e(route('digital_coupon_detail_purchased',':id')); ?>";
                          route = route.replace(':id',this.data_id);
                        }else {
                          var route = this.url;
                        }
  ...
  <?php if(\Request::route()->getName() == 'contact_us' || \Request::route()->getName() == 'ticket_history'): ?>
        $.ajax({
                  ...
                  if(response.status == "200") {
                   ...
                   $("#ticket-send").modal("show");
                    setTimeout(function(){
                      if(token)
                      {
                        location.href = "<?php echo e(route('ticket_history')); ?>";
                      }
                      else
                      {
                        location.href = "<?php echo e(route('web_home')); ?>"
  ...
  /*################# CONTACT US :: SCRIPT STARTS #################*/
  <?php if(\Request::route()->getName() == 'ticket_history'): ?>
      var page = 1;
      load_more(page);
      var last_page = '';
      $(".ticket-list").html('');
  ...
  /*################ CMS PAGES ::SCRIPT START #####################*/
      <?php if(\Request::route()->getName() == 'about_us' || \Request::route()->getName() == 'terms_and_condition' || \Request::route()->getName() == 'privacy_policy'): ?>
      ...
      function cms_pages() {
          $.ajax({
                 ...
                 success: function(response) {
                    if(response.status == "200") {
                          <?php if(\Request::route()->getName() == 'about_us'): ?>
                             about_us_page(response.data.about_us);
                          <?php endif; ?>
                          <?php if(\Request::route()->getName() == 'terms_and_condition'): ?>
                            terms_page(response.data.terms_page_url);
                          <?php endif; ?>
                           <?php if(\Request::route()->getName() == 'privacy_policy'): ?>
    ...
    <?php if(\Request::route()->getName() == 'books_checkout' || \Request::route()->getName() == 'coupons_checkout'): ?>
      ...
      $("#no_btn").click(function(){
        ...
        location.href = "<?php echo e(route('my_cart')); ?>?no_btn=1";
       });
    <?php endif; ?>
});
</script><?php /**PATH /opt/lampp/htdocs/ssgc-bulk/resources/views/customer/scripts.blade.php ENDPATH**/ ?>