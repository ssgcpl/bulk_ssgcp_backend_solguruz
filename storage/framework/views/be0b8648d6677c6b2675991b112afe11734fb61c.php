<ul>
    <?php $__currentLoopData = $childs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <?php if(count($child->sub_category)): ?>
            <?php echo $__env->make('admin.products.manage_child_checkbox',[
                'childs' =>
                    $child->sub_category,
...
<?php /**PATH /opt/lampp/htdocs/ssgc-bulk/resources/views/admin/products/manage_checkbox.blade.php ENDPATH**/ ?>