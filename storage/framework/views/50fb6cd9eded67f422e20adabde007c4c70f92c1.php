  ...
  <section class="inner-page-banner">
      <div class="container"> 
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">  <a href="<?php echo e(route('suggestions')); ?>">Suggestion</a>  </li>
        </ol> 
      </div>
  </section> 
...
<?php echo $__env->make('customer.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/ssgc-bulk/resources/views/customer/suggestion.blade.php ENDPATH**/ ?>