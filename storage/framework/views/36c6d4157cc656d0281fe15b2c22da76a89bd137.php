    ...
    <div class="container">
      <div class="search-field">
        <div class="box">
          ...
          <button class="search-btn" id="search_btn"><img src="<?php echo e(asset('web_assets/images/search.svg')); ?>" alt=""></button>
        </div>
      </div>
    </div>
  </section>  
    ...
    <div class="container">
      <div class="section-title">
        <h2>Make My Return</h2>
         <!-- href="<?php echo e(route('make_my_return')); ?>" -->
  ...
  <section class="trending-book white-bg">
    <div class="container">
      <div class="section-title">
        ...
        <a href="<?php echo e(route('trending_books')); ?>" title="" class="view_all_btn">View All</a>        
      </div>
...
<?php echo $__env->make('customer.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/ssgc-bulk/resources/views/customer/home.blade.php ENDPATH**/ ?>