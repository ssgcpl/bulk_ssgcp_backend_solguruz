    ...
    <div class="row">
      <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12">  
        <div class="about-info">
          <div class="footer-logo"><img src="<?php echo e(asset('web_assets/images/logo.svg')); ?>" alt=""></div>
          <ul>
	    ...
	    <li><a target="_blank" id="telegram"><i class="fab fa-telegram"></i></a></li>	    
            ...
            <li><a target="_blank" id="twitter"><img src="<?php echo e(asset('web_assets/images/x-icon.svg')); ?>" alt=""></a></li>
          </ul> 
        </div>
      </div>
      ...
      <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
        ...
        <div class="footer-link">
          <ul>
              ...
              <li><a href="<?php echo e(route('terms_and_condition')); ?>">Terms & Condition</a></li>                
          ...
          <div class="contact-info">
            <ul>
                <li>
                    ...
                    <div class="details"><?php echo e(\App\Models\Setting::get('contact_address')); ?></div>
                </li>
                <li>
                    <div class="icon"><i class="fas fa-envelope"></i></div>
                    <div class="details"><a href="mailto:<?php echo e(\App\Models\Setting::get('contact_email')); ?>" title=""><?php echo e(\App\Models\Setting::get('contact_email')); ?></a></div>
                </li>
                <li>
                    <div class="icon"><i class="fas fa-phone-alt"></i></div>
                    <div class="details"><a href="tel:<?php echo e(\App\Models\Setting::get('customer_care_no')); ?>" title="">+1 <?php echo e(\App\Models\Setting::get('customer_care_no')); ?></a></div>
                </li>
              </ul>
          </div>
      </div>
      <div class="col-xl-2 col-lg-2 col-md-6 col-sm-12">
        ...
        <div class="download-app">
          <a href="#" title=""><img src="<?php echo e(asset('web_assets/images/app-store.svg')); ?>" alt=""></a>
          <a href="#" title=""><img src="<?php echo e(asset('web_assets/images/google-play.svg')); ?>" alt=""></a>
        </div>
      </div>
    </div> 
  </div>  
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body"> 
        ...
        <div class="button-list text-center">
          <a href="<?php echo e(route('my_orders')); ?>" id="redirect_url" type="button" class="btn primary-btn">Ok</a>
        </div>    
      </div>     
    </div>
  </div>
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body"> 
        ...
        <div class="button-list text-center">
          <a href="<?php echo e(route('signin')); ?>" id="redirect_url" type="button" class="btn primary-btn">Sign in</a>
        </div>  
        <div class="signup-detail mt-4">
            <p>Don’t have an account? <a href="<?php echo e(route('signup')); ?>" style="color: #33A1E1;" >Sign Up</a></p>  
            ...
            <div class="box">                        
                ...
                <div class="upload-img">
                    ...
                    <label class="file-input-label" for="receipt_image">
                        <img src="<?php echo e(asset('web_assets/images/uplod-file.png')); ?>" alt="">
                        Add Image
                    </label>
                </div>
            </div>
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body"> 
        ...
        <div class="button-list">        
          <a href="<?php echo e(route('make_my_return')); ?>" class="btn secondary-btn">Add More</a>
          <a href="<?php echo e(route('return_cart')); ?>" class="btn primary-btn">Go to Return Cart</a>
        </div>
      </div>     
    </div>
  </div>
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body"> 
        ...
        <div class="button-list text-center">
          <a href="<?php echo e(route('web_home')); ?>" type="button" class="btn primary-btn">Continue</a>
        </div>    
      </div>     
    </div>
  </div>
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body"> 
        ...
        <p>Your Item has been added successfully</p>     
        <div class="button-list text-center">
          <a href="<?php echo e(route('my_cart')); ?>" type="button" class="btn secondary-btn">Go To Cart</a>
...
<div id="usertype_change_modal" class="fade modal delete-confirm">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body"> 
        <div class="success-img">
          <lottie-player src="<?php echo e(asset('web_assets/images/error-user.json')); ?>" background="transparent" speed="1" loop autoplay></lottie-player>
        </div>
        ...
        <a href="<?php echo e(route('my_cart')); ?>" class="btn primary-btn">Go To Cart</a>        
      </div>     
    </div>
  </div>
</div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="share-option">
          ...
          <ul>
            <li><a href="" id="refer_earn_facebook" target="_blank"><img src="<?php echo e(asset('web_assets/images/facebook-share.svg')); ?>"><p>Facebook</p></a></li>
            <li><a href="" id="refer_earn_twitter" target="_blank"><img src="<?php echo e(asset('web_assets/images/twitter.svg')); ?>"><p>Twitter</p></a></li>
            <li><a href="" id="refer_earn_wtapp" target="_blank"><img src="<?php echo e(asset('web_assets/images/whatsapp.svg')); ?>"><p>Whatsapp</p></a></li>
            <li><a href="" id="refer_earn_instagram" target="_blank"><img src="<?php echo e(asset('web_assets/images/instagram.svg')); ?>"><p>Instagram</p></a></li>
          </ul> 
        </div>
      </div>      
    </div>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body text-center">
        ...
        OR <br> you need to wait for <?php echo e(floor(\App\Models\Setting::get('payu_job_delay_in_seconds'))/60); ?> minute to confirm this transaction status.</p>
         <div class="button-list text-center">
...
<?php /**PATH /opt/lampp/htdocs/ssgc-bulk/resources/views/customer/elements/footer.blade.php ENDPATH**/ ?>