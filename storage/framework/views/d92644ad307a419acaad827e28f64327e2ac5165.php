              ...
              <div class="col-12">
                  ...
                  <div class="breadcrumb-wrapper col-12">
                      <ol class="breadcrumb">
                          ...
                          <li class="breadcrumb-item active"><?php echo e(trans('order_return.create')); ?>
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          ...
                          <select id="user_id" name="user_id" class="select2 form-control">
                            ...
                            <option value="<?php echo e($customer->id); ?>"><?php echo e($customer->id); ?>,<?php echo e($customer->first_name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                          </select>
                        </div>
                      </div>
                              ...
                              <table class="table zero-configuration data_table_ajax">
                                ...
                                <tfoot>
                                  <tr>
                                    ...
                                    <th><?php echo e(trans('order_return.refundable_amount')); ?></th>
                                    <th><?php echo e(trans('order_return.weight')); ?></th>
                                    <th><?php echo e(trans('order_return.stock')); ?></th>  <th><?php echo e(trans('common.action')); ?></th> </tfoot>
                                  </tr>
                              </table>
                            </div> 
                            <div class="row">
...
<script type="text/javascript">
    ...
    function fill_datatable() {
      $('.data_table_ajax').DataTable({ 
       ...
       // dom: 'Blfrtip',
        ...
        ajax: {
            url: "<?php echo e(route('dt_product_list')); ?>",
            data: {
        ...
        columns: [
           ...
           { data: 'stock',orderable: false},
           {
            data: '',
                ...
                return '<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check("order-delete")): ?><a href="javascript:void(0)" id="'+row['id']+'" class="delete_btn"><i class="fa fa-trash"></i></a><?php endif; ?>';
    ...
    $('#notifyUserForm').submit(function(evt){
          ...
          $.ajax({
                  ...
                  beforeSend: function(xhr){
                      ...
                      $('#update_return_note').text("<?php echo e(trans('common.submitting')); ?>");
                    },
                  success: function(response) {
                      console.log(response);
                      if(response.success) {
                      ...
                      $('#update_return_note').text("<?php echo e(trans('common.submit')); ?>");
                  }
          });
    }) 
      ...
      event.preventDefault();
       ...
       /* if($("#user_id").val() == '') {
         ...
         var barcode = $("#barcode").val();
          ...
          $.ajax({
                  url: '<?php echo e(route("check_barcodes")); ?>',
    ...
    $("#create_order_return").click(function(evt){
       ...
       evt.preventDefault();
        ...
        $.ajax({
                  url: '<?php echo e(route("create_order_returns_item")); ?>',
                  data: {
                          "user_id" : user_id,
                          "total_mrp":total_mrp,
                  ...
                  success: function(response) {
                    if(response.error){
                     ...
                     toastr.success(response.success);
                     var route = "<?php echo e(route('order_return.edit',':id')); ?>";
     ...
     $(document).on("click",'.delete_btn',function(){
        ...
        var route = "<?php echo e(route('delete_verified_product',':id')); ?>";
...
<?php echo $__env->make('layouts.admin.elements.live_stream_js', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/ssgc-bulk/resources/views/admin/order_return/create.blade.php ENDPATH**/ ?>