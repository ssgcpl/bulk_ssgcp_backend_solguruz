    ...
    'routes' => [
        [
            ...
            'exclude' => [
                ...
                'api/customer/email/resend',
                'api/driver/email/verify/*',
                'api/driver/email/resend',
                'api/customer/terms_and_conditions*',
                'api/customer/about_us*',
                'api/customer/privacy_policy*',
                'api/customer/customer_faqs*',
                // '/health', 'admin.*'
            ],
